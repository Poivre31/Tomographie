...
int main()
{
    ...
    add_photon_noise(projection, 40);
    add_background_noise(projection, 0.01);
    ...
    weight_data_with_window(polar, d_max / 4);
    ...
    display_images({phantom, projection, ffti_2D(polar).modulus_to_image()}, 1);
}