...
double sample_covariance(image im1, image im2, image weight = image(0, 0))
{
...
double mssim(image im1, image im2, bool log_scale = false, size_t window_width = 11, double stdev = 1.5)
{
    im1 = normalize(im1);
    im2 = normalize(im2);
